...
/*   Updated: 2025/01/09 12:00:50 by yooshima         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string replaceLine(const std::string line, const std::string str1,
...
bool processFile(const std::string filename, const std::string str1,
                 const std::string str2) {
...
int main(int argc, char **argv) {
  if (argc != 4) {
    std::cerr << "Error: Invalid args. \"./replace filename str1 str2\""
              << std::endl;
    return 1;
  }
  ...
  if (!processFile(argv[1], argv[2], argv[3])) return 1;
  return 0;
}